...
function guardar() {
    ...
    var var1 = document.getElementById("dataNoticia").value;
    var var2 = document.getElementById("titolNoticia").value;
    var var3 = document.getElementById("enllaçNoticia").value;
    var var4 = document.getElementById("descripcioNoticia").value;
    ...
    if (var1 == "") {
        document.getElementById('errorData').innerHTML = 'Error, la data no pot estar vuida.';
    }
    else {
        document.getElementById('errorData').innerHTML = 'Correcte';
        controladorErrors++;
    }
    // Comprovacio si el valor del titol esta vuit
    if (var2 == "") {
        document.getElementById('errorTitol').innerHTML = 'Error, el titol no pot estar vuit.';
    }
    else {
        document.getElementById('errorTitol').innerHTML = 'Correcte';
        controladorErrors2++;
    }
    // Comprovacio si el titol es un numero
    if (isNaN(var2Res) == false) {
        document.getElementById('errorTitol').innerHTML = 'Error, el titol no pot ser un numero';
    }
    else {
        document.getElementById('errorTitol').innerHTML = 'Correcte';
        controladorErrors2++;
    ...
    if (controladorErrors2 == 2) {
        ...
        document.getElementById('errorTitol').innerHTML = 'Error, en la part del titol.';
    }
    ...
    if (controladorErrors1 == 3) {
        document.getElementById('errorEnllaç').innerHTML = 'Correcte. ';
        controladorErrors++;
    }
    else {
        document.getElementById('errorEnllaç').innerHTML = 'Error, Error en la part del enllaç.';
    }
    // Comprovacio si la descripcio de la noticia esta vuida o no
    if (var4 == "") {
        document.getElementById('errorDescripcio').innerHTML = 'Error, la descripcio no pot estar vuida.';
    }
    else {
        controladorErrors3++;
    }
    ...
    if (isNaN(var4Res) == false) {
        document.getElementById('errorDescripcio').innerHTML = 'Error, la descripcio no pot ser un numero.';
    }
    else {
        controladorErrors3++;
    }
    ...
    if (controladorErrors3 == 2) {
        document.getElementById('errorDescripcio').innerHTML = 'Correcte.';
        controladorErrors++;
    }
    else {
        document.getElementById('errorDescripcio').innerHTML = 'Error en la part de la descripcio. ';
    }
    ...
    if (controladorErrors == 4) {
        document.getElementById("errorControlErrors").innerHTML = "Correcte";
        ...
        var recollida = document.getElementById("noticiesColocades");
        ...
        document.getElementById("errorControlErrors").innerHTML = "Error, hi ha un camp que no esta be.";
    }
}
function guardarMenu() {
    // Valors de la funcio
    var var5 = document.getElementById("titolMenu").value;
    var var6 = document.getElementById("subelementsMenu").value;
    var var12 = document.getElementById("subelementsMenu2").value;
    var var7 = document.getElementById("estilsNoticia").value;
    var var8 = document.getElementById("estilsNoticiaSubelement").value;
    var estilSubElement = document.getElementById("estilsNoticiaSubelement2").value;
    ...
    var recollida = document.getElementById("menuDesplegable");
...
window.onload = function () {
    ...
    var recollida2 = document.getElementById("noticiesColocades");
    ...
    var recollida3 = document.getElementById("noticiesColocades");
